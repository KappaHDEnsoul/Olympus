    ...
    static class MenuManager
    {
        ...
        public static class Execute
        {
            public static void General()
            {
                ...
                AddBool(OlympusAIO.MainMenu, "DisableAntiDC", "Disable Anti-DC in Core", false);
                ...
                if (!OlympusAIO.SupportedChampions.All(x => !string.Equals(x, OlympusAIO.objPlayer.CharacterName, StringComparison.CurrentCultureIgnoreCase)))
                {
                    ...
                    AddKeyBind(OlympusAIO.MainMenu, "SpellFarm", "Enabled Spell Farm", System.Windows.Forms.Keys.J, KeyBindType.Toggle).SetValue(true).Permashow(true, "Enabled Spell Farm [MouseWheel] &");
                    AddKeyBind(OlympusAIO.MainMenu, "SpellHarass", "Enabled Spell Harass", System.Windows.Forms.Keys.H, KeyBindType.Toggle).SetValue(true).Permashow();
            ...
            public static void Poppy()
            {
                ...
                AddKeyBind(ComboMenu, "EFlashForced", "Force Flash+E Key", System.Windows.Forms.Keys.T, KeyBindType.Press).Permashow();
